...
import 'package:bi_mistik/pages/profile/reward_page.dart';
import 'package:bi_mistik/pages/profile/about_page.dart';
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: profileData?['avatar_url'] != null
                                    ? (profileData!['avatar_url'].toString().startsWith('assets/')
                                        ? AssetImage(profileData!['avatar_url']) as ImageProvider
                                        : NetworkImage(profileData!['avatar_url']))
                                    : NetworkImage('https://ui-avatars.com/api/?name=$fullName&background=random'),
                              ),
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      ).then((_) => _fetchProfile()); // Refresh profile data when returning
                    },
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.map_outlined,
                color: Color(0xFF213049), size: 30),
          ),
          const SizedBox(height: 4),
          const Text('Map',
              style: TextStyle(
